...
from app.api.agent_telemetry import router as agent_telemetry_router
...
from app.llm.admin.api import router as llm_admin_router
...
api_router.include_router(agent_telemetry_router, prefix="/agent", tags=["Agent Telemetry"])
...
# LLM 模型管理（多模型接入）
api_router.include_router(llm_admin_router, tags=["LLM Admin"])
