...
2. 生产阻塞 model（approvals / recommendations / command_audit_log）中
...
LOWERCASE_DBLABEL_ENUMS = {
    ...
    "InterviewRound",       # interview_round: phone_screen/... (表未建)
    "EvaluationVerdict",    # evaluation_verdict: strong_hire/... (表未建)
}
...
def main() -> int:
    ...
    print(
        ...
        f" + {len(UUID_SCAN_FILES)} 个 UUID 扫描，均无违规"
    )
    return 0
